...
import { ArrowLeft, FileCheck, Loader2, Mail, Phone } from "lucide-react";
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			toast.error("Setup failed", {
				description: String(err) || "An unexpected error occurred.",
			});
		}
	};
							...
							<div className="space-y-3 p-3">
								...
								<div className="space-y-1.5">
									...
									<Input
										...
										onChange={(e) =>
											onChange("pharmacyAddress", e.target.value)
										}
								...
								<div className="grid grid-cols-2 gap-3">
									<div className="space-y-1.5">
										...
										<Input
											...
											onChange={(e) =>
												onChange("pharmacyPhone", e.target.value)
											}
									...
									<div className="space-y-1.5">
										...
										<Input
											...
											onChange={(e) =>
												onChange("pharmacyEmail", e.target.value)
											}
								...
								<div className="space-y-1.5">
									...
									<Input
										...
										onChange={(e) =>
											onChange("pharmacyLicense", e.target.value)
										}
